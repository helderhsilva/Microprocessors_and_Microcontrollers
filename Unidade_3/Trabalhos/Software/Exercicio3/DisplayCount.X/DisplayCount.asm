...
; Projeto: Exercício 3 - Display Incrementa/Decrementa (0-99)
...
;cria constantes para o programa
	...
	cblock  0x20
		; Variáveis usadas na rotina de delay.
		    ...
		    tempo2
		    filtro
		; Variáveis para verificação de incremento e decremento
	endc 
...
inicio:
	...
	movlw	    0x06
	movwf	    TRISB			    ; Configura PortB, bit 1 e bit 2 como entrada e o resto saída
